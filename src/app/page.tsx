...
export default function Home() {
  return (
    <main className="bg-[#0a0a0a] min-h-screen font-sans selection:bg-orange-500 selection:text-white">
      <Navbar />
      <Hero />
      <Marquee />
          ...
          <div className="flex flex-col md:flex-row items-start md:items-end gap-12 flex-1">
            ...
            <div className="relative aspect-[3/4] w-full max-w-[300px] rounded-3xl border border-white/10 overflow-hidden bg-white/5 order-2 md:order-1">
              <Image 
                ...
                fill 
                className="object-cover object-top mix-blend-luminosity hover:mix-blend-normal transition-all duration-1000" // Added blending effects
                sizes="300px"
              />
            </div>
